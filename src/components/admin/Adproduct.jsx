...
const AddProductPage = () => {
  ...
  return (
    <Layout>
      <div>
        <div className="flex justify-center items-center h-screen bg-[#0369a1]">
          {loading && <Loader />}
          {/* Login Form  */}
          <div className="login_Form bg-[#2186b5] px-8 py-6 border border-pink-100 rounded-xl shadow-md">
            {/* Top Heading  */}
            <div className="mb-5">
