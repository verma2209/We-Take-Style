    ...
    <Layout>
      <div>
        ...
        <div className="top mb-5 px-5 mt-5">
          <div className=" bg-blue-800  hover:bg-blue-900 py-5 border border-black rounded-lg">
        ...
        <div className="px-5">
          ...
          <div className="mid mb-5">
            {/* main  */}
            <div className=" bg-pink-500 hover:bg-pink-600 py-5 rounded-xl border border-pink-100">
              {/* image  */}
            ...
            <Tabs>
              <TabList className="flex flex-wrap -m-4 text-center justify-center">
                ...
                <Tab className="p-4 md:w-1/3 sm:w-1/2 w-full cursor-pointer">
                  <div className=" border bg-blue-800 hover:bg-blue-900 border-black px-4 py-3 rounded-xl transition ease-in-out delay-10 hover:-translate-y-1 hover:scale-110 duration-300">
